...
Supports both [Qt5](https://doc.qt.io/qt-5/qtqml-cppintegration-definetypes.html) and [Qt6](https://doc.qt.io/qt-6/qtqml-cppintegration-definetypes.html).
...
and [Qt 6 QtQml directory imports](https://doc.qt.io/qt-6/qtqml-syntax-directoryimports.html#directory-listing-qmldir-files) for additional info.
