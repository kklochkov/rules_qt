...
| :------------- | :------------- | :------------- |
| <a id="materialize_qt_repo-repository_ctx"></a>repository_ctx |  The repository rule context.   |  none |
| <a id="materialize_qt_repo-qt_dir"></a>qt_dir |  Path to the Qt installation prefix directory containing bin/qmake.   |  none |
